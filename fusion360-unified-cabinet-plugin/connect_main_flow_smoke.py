...
def run(_context):
    ...
    try:
        ...
        import adapter
        import connect_main_flow_runner
        import connect_smoke_runner

        importlib.reload(connect_smoke_runner)
        importlib.reload(connect_main_flow_runner)

        from connect_main_flow_runner import format_summary, run_connect_main_flow_smoke
        ...
        result = run_connect_main_flow_smoke(
        ...
        if ui:
            ui.messageBox("Connect main flow smoke FAILED:\n{}".format(traceback.format_exc()))
        raise
